...
const footerLinks = {
  ...
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/vzwjustin/OmniCode/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/vzwjustin/OmniCode", external: true },
    { label: "Blog", href: "https://github.com/vzwjustin/OmniCode/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/vzwjustin/OmniCode/issues/new/choose",
      external: true,
    },
