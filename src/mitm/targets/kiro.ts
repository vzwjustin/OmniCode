...
export const KIRO_MITM_PROFILE: MitmTarget = {
  ...
  name: "Kiro IDE",
  description:
    "Intercepts Kiro IDE requests to api.anthropic.com and routes them through OmniCoder.",
  ...
  instructions: [
    ...
    "4. Open Kiro IDE — API calls will be automatically routed through OmniCoder.",
    "5. Verify: check the Proxy Logs in OmniCoder dashboard and look for provider=anthropic source=mitm",
  ],
