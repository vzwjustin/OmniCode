 ...
 *
 * Resets the admin password for OmniCoder.
...
console.log("\n🔑 OmniCoder — Password Reset\n");

async function main() {
  // Check if database exists
  if (!existsSync(DB_PATH)) {
    console.error(`❌ Database not found at: ${DB_PATH}`);
    console.error(`   Make sure OmniCoder has been started at least once.`);
  ...
  console.log("   Restart OmniCoder for changes to take effect.\n");
}
